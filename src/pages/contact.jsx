    ...
    return (
        <>
            ...
            <motion.div
                ...
                <form onSubmit={onSubmit} ref={writing} className={`p-20 max-md:p-5 bg-white/25 rounded-lg flex flex-col gap-3 hover:transition-all transition-all hover:shadow-[0_0_10px_0_blue,0_0_20px_0_blue] ${bool ? "shadow-[0_0_10px_0_blue,0_0_20px_0_blue]" : ""}`}>
                    <h1 className="text-center text-4xl max-md:text-2xl text-white  font-extrabold"><span className="text-blue-600">Get</span> In Touch</h1>
